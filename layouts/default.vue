<template>
    <div>
        ...
        <nav role="main-navigation" class="fixed top-0 left-0 z-50 w-full h-screen bg-[#060210] px-10 origin-top">
            <ul class="flex flex-col mt-28 gap-4">
                ...
                <li>
                    <NuxtLink class="text-5xl" @click="toggleMenu">Classifica</NuxtLink>
                </li>
            </ul>
